import {
  ...
  ENABLE_FREELANCE_RU,
  START_DOWNLOADING_FREELANCE_RU, STOP_DOWNLOADING_KWORK, STOP_DOWNLOADING_FREELANCE_RU,
} from '../types';
...
export const switchDataAction = {
  kwork: {
    ...
    setStopDownload: () => ({ type: STOP_DOWNLOADING_KWORK }),
  },
  freelanceRu: {
    ...
    setStopDownload: () => ({ type: STOP_DOWNLOADING_FREELANCE_RU }),
  }
}